...
export class MajorityElectionBallotGroupDetailComponent {
  ...
  public handleUpdatedBallotGroupCandidatesAssign(ballotGroupCandidates: MajorityElectionBallotGroupCandidates): void {
    this.ballotGroupCandidates = ballotGroupCandidates;
